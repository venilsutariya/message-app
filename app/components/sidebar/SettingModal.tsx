        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-12">
                <div className="border-b border-gray-500 pb-12">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-300">Edit your public information</p>
                    ...
                    <div className="mt-10 flex flex-col gap-y-8">
                        ...
                        <div>
                            ...
                            <div className="mt-2 flex items-center gap-x-3">
                                <Image width={"48"} height={"48"} className=" rounded-fill" src={image || currentUser?.image || '/images/placeholder.webp'} alt="Avatar"/>
                                <CldUploadButton 
                                 options={{ maxFiles: 1}}
